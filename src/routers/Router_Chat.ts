...
const upload = multer();
import { contensChat } from "../models/chat/Model_ContentChat";
import { config_chatFunc } from "../models/configs/Model_ConfigChat";
import { createOrUpdateOrLoad_chat } from "../controllers/chat/Ctrl_Chat"
//to get the friends who are not in the chatrooms
import { methods as methodsFriends, user_user } from "../models/Model_UserUser"
import { methods as methodsChat_members, chat_member } from "../models/chat/Model_ChatMember"
import { Op, where } from "sequelize";
import { route as routerOfSearch } from "./Router_Search";
