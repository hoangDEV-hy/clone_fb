...
export let methods = {
    ...
    selectGroupsPost: async (userId: string) => {
        // Truy vấn 1: Lấy danh sách group_user mà user tham gia
        ...
        // Truy vấn 2: Lấy posts từ các group đó
        ...
        // Lọc ra những group_user có posts (giống như required: true trong join)
