...
// ============================================================
// FOLLOWER CONTROLLER
// Responsibility: Business logic for follower operations
// ============================================================

export const FollowerController = {
    selectDanhSach: async (selectedFollowerID: string, page: number) => {
        try {
    ...
    checkFollowing: async (follower: string, following: string): Promise<boolean> => {
