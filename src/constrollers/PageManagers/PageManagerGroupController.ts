...
import { methods as groupUserModel } from '../../Models/GroupUser';
...
// ============================================================
// PAGE MANAGER GROUP CONTROLLER
// Responsibility: Business logic for page manager group operations
// ============================================================

export const PageManagerGroupController = {
    /**
     ...
     * Create new group
     */
    createGroup: async (adminId: string, name: string, hastag?: string): Promise<void> => {
        ...
        try {
            ...
            await groupUserModel.addMember(adminId, newGroup.id, 'active', transaction);
    ...
    acceptJoinRequest: async (
        ...
        try {
            ...
            const affectedRows = await groupUserModel.updateMemberStatus(userId, groupId, 'active', transaction);
    ...
    rejectJoinRequest: async (
        ...
        try {
            ...
            const deletedCount = await groupUserModel.deleteMember(targetUserId, groupId, 'pending', transaction);
    ...
    leaveGroup: async (userId: string, groupId: number): Promise<void> => {
        ...
        try {
            ...
            const deletedCount = await groupUserModel.deleteMember(userId, groupId, 'active', transaction);
    ...
    removeMember: async (
        ...
        try {
            ...
            const deletedCount = await groupUserModel.deleteMember(targetUserId, groupId, 'active', transaction);
    ...
    getGroupMembers: async (
        ...
        try {
            ...
            const activeMembers = await groupUserModel.getGroupMembersByGroupId(groupId, 'active');
